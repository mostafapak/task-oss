...
public class Mostafa{
    ...
    public int Age{
        ...
        set { 
                ...
                {
                    throw new Exception("error on the Age");
                }
                _age = value; 
            }
    }
...
public class Student : Person {
    ...
    public int Year{
        ...
        set { 
                if(value < 1 || value > 5)
                {
                throw new Exception("error on the Year");
                }
                _year = value; 
            }
    }
    ...
    public float Gpa{
        ...
        set { 
                if(value < 0 || value > 4)
                {
                throw new Exception("error on the Gpa");
                }
                _gpa = value; 
            }
    }
    ...
    public override void Print(){
        Console.WriteLine($"My name is : {Name}, my age is: {Age}and and gpa is : {Gpa}");
    }
}
...
public class Staff : Person {
    ...
    public override void Print(){
        Console.WriteLine($"My name is: {Name}, my age is: {Age}and and my salary is: {Salary}");
    }
